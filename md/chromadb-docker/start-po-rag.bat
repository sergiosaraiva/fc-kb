...
docker-compose -f docker-compose-with-po-rag.yml ps | findstr "chromadb" | findstr "healthy" >nul
if errorlevel 1 (
...
docker-compose -f docker-compose-with-po-rag.yml ps | findstr "product-owner-rag" | findstr "healthy" >nul
if errorlevel 1 (
...
echo.
echo View logs:
echo   docker-compose -f docker-compose-with-po-rag.yml logs -f product-owner-rag
echo.
echo Stop services:
